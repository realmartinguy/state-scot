  ...
  'social-security': {
    ...
    indicators: [
      ...
      },      
      {
        ...
        target: null,
        current:  { value: '62 days', raw: 62, period: 'Q1 2026' },
        previous: { value: '57 days', raw: 57, period: 'Q4 2025' },
  ...
  housing: {
    ...
    indicators: [
      ...
      },
      {
        ...
        description: 'Number of households in Scotland living in temporary accommodation.',
        target: null,
      ...
      },
      {
        ...
        description: 'Total number of houses built (completed) in the previous 12 months.',
        target: null,
      ...
      },
      {
        ...
        description: 'Number of houses built (completed) by the private sector in the previous 12 months.',
        target: null,
      ...
      },
      {
        ...
        description: 'Total number of new housebuilding starts in the previous 12 months.',
        target: null,
        current:  { value: '14,999', raw: 14999, period: 'Year to December 2025' },
        previous: { value: '15,050', raw: 15050, period: 'Year to December 2024' },
        change: { value: '51', direction: 'down' },
        status: 'red',
        narrative: 'The total number of housebuilding starts has decreased.',
        source: { name: 'Scottish Government', url: 'https://www.gov.scot/publications/quarterly-housing-statistics-march-2026/' }
      },
      {
        id: 'housing-starts-private',
        title: 'New Housebuilding Starts - Private Sector',
        description: 'Number of new housebuilding starts by the private sector in the previous 12 months.',
        target: null,
        current:  { value: '11,929', raw: 11929, period: 'Year to December 2025' },
        previous: { value: '11,617', raw: 11617, period: 'Year to December 2024' },
        change: { value: '312', direction: 'up' },
        status: 'green',
        narrative: 'The number of housebuilding starts by the private sector has increased.',
        source: { name: 'Scottish Government', url: 'https://www.gov.scot/publications/quarterly-housing-statistics-march-2026/' }
      },
      {
        id: 'housing-starts-social',
        title: 'New Housebuilding Starts - Social Sector',
        description: 'Number of new housebuilding starts by the social sector in the previous 12 months.',
        target: null,
        current:  { value: '3,070', raw: 3070, period: 'Year to December 2025' },
        previous: { value: '3,433', raw: 3433, period: 'Year to December 2024' },
        change: { value: '363', direction: 'down' },
        status: 'red',
        narrative: 'The number of housebuilding starts by the social sector has decreased.',
        source: { name: 'Scottish Government', url: 'https://www.gov.scot/publications/quarterly-housing-statistics-march-2026/' }
      }
    ]
  },
  ...
  transport: {
    ...
    indicators: [
      ...
      },
      {
        ...
        target: null,
        current:  { value: '2.48%', raw: 2.48, period: 'July 2026' },
        previous: { value: '5.77%', raw: 5.77, period: 'July 2025' },
        change: { value: '3.29pp', direction: 'down' },
        status: 'green',
      ...
      },
      {
        ...
        target: null,
        current:  { value: '4.71%', raw: 4.71, period: 'July 2026' },
        previous: { value: '4.50%', raw: 4.50, period: 'July 2025' },
        change: { value: '0.21pp', direction: 'up' },
        status: 'red',
        narrative: 'The proportion of CalMac sailings which arrived late has increased.',
        source: { name: 'CalMac', url: 'https://corporate.calmac.co.uk/en-gb/about-us/performance-reports/regional-performance/' }
      },
      {
